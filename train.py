...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="./data/", help="The dataset's directory")
    parser.add_argument("--add_position_features", action='store_true', default=False, help="Use position embeddings or not")
    ...
    parser.add_argument("--epoches", type=int, default=15, help="Number of training epochs")
    ...
    parser.add_argument(
        ...
        default=1.0,
        help=(
            "Base of Exponential decay for Schedule Sampling. "
    ...
    parser.add_argument("--save_dir", type=str, default="./ckpts", help="The directory to save checkpoints")
    parser.add_argument("--print_freq", type=int, default=100, help="The frequency to print messages")
    parser.add_argument("--seed", type=int, default=2020, help="The random seed for reproducibility")
    ...
    if from_check_point:
        ...
        lr_scheduler.load_state_dict(checkpoint['lr_scheduler_state_dict'])  # Assuming correct key
        # Initialize trainer from checkpoint
        trainer = Trainer(
            optimizer, model, lr_scheduler,
